...
class LoggerWithoutCallSite {
    ...
    _buildErrorObject(error, exposeErrorCodeFrame = true, stackOffset = 0, stackLimit = Infinity) {
        ...
        if (errorObject.stack.length > 0) {
            const errorCallSite = LoggerHelper_1.LoggerHelper.toStackFrameObject(this._callSiteWrapper(relevantCallSites[0]));
            ...
            argumentsArray: logObject.argumentsArray.map((argument) => {
                ...
                if (typeof argument === "object" && (errorObject === null || errorObject === void 0 ? void 0 : errorObject.isError)) {
                    return {
                        ...
                        errorString: this._formatAndHideSensitive(errorObject.nativeError),
                    };
                }
                else if (typeof argument === "object") {
    ...
    _inspectAndHideSensitive(object, options) {
        ...
        try {
            ...
            formatted = util_1.inspect(maskedObject, options);
        }
        catch {
            formatted = util_1.inspect(object, options);
        }
