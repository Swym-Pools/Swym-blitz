...
var blitzData = require('./blitz-data-d800ac04.cjs.prod.js');
...
if (process.env.JEST_WORKER_ID === undefined) {
  SuperJson__default['default'].allowErrorProps.apply(SuperJson__default['default'], errorProps);
}
...
if (process.env.JEST_WORKER_ID === undefined) {
  SuperJson__default['default'].registerClass(AuthenticationError, {
...
if (process.env.JEST_WORKER_ID === undefined) {
  SuperJson__default['default'].registerClass(CSRFTokenMismatchError, {
...
if (process.env.JEST_WORKER_ID === undefined) {
  SuperJson__default['default'].registerClass(AuthorizationError, {
...
if (process.env.JEST_WORKER_ID === undefined) {
  SuperJson__default['default'].registerClass(NotFoundError, {
...
if (process.env.JEST_WORKER_ID === undefined) {
  SuperJson__default['default'].registerClass(PaginationArgumentError, {
