...
function _getBlitzRuntimeData() {
  ...
  var middleware = (_config$middleware = config.middleware) == null ? void 0 : _config$middleware.filter(function (middleware) {
  ...
  return {
    ...
    suspenseEnabled: ((_config$experimental = config.experimental) == null ? void 0 : _config$experimental.reactRoot) !== false
  };
}
...
export { BlitzData as B, isServer as a, clientDebug as c, getBlitzRuntimeData as g, isClient as i };
