  ...
  try {
    ...
    if (fsExtra.existsSync(nextConfigPath)) {
      ...
      if (typeof loadedNextConfig === "function") {
        var phase =         "production" === "production" ? PHASE_PRODUCTION_SERVER : PHASE_DEVELOPMENT_SERVER;
    ...
    if (typeof loadedBlitzConfig === "function") {
      var _phase =         "production" === "production" ? PHASE_PRODUCTION_SERVER : PHASE_DEVELOPMENT_SERVER;
