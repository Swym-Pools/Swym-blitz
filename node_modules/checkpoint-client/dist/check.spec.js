  ...
  describe('others', () => {
    ...
    it(
      ...
      async function () {
        ...
        const checkpoint = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(path__default['default'].join(tmpdir, 'node_modules', 'checkpoint-client'))); });
