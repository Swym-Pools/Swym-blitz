...
const debug = debug_1.default('prisma:download');
...
async function download(options) {
    ...
    const binaryJobs = flatMap_1.flatMap(Object.entries(opts.binaries), ([binaryName, targetFolder]) => opts.binaryTargets.map((binaryTarget) => {
        ...
        const targetFilePath = binaryName === EngineTypes.libqueryEngineNapi
            ? path_1.default.join(targetFolder, get_platform_1.getNapiName(binaryTarget, 'fs'))
            : path_1.default.join(targetFolder, fileName);
        return {
            binaryName,
            targetFolder,
            binaryTarget,
